...
from models.bert_model import MoSiNetREModel, MoSiNetNERModel
from processor.dataset import MMREProcessor, MMPNERProcessor, MMREDataset, MMPNERDataset
from modules.trainer import RETrainer, NERTrainer
...
def main():
    ...
    parser.add_argument('--load_path', default='ckpt/ckpt/best_model_MRE.pth', type=str, help="Load model from load_path")
